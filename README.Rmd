...
## Overview
toscca is an R package to perform Thresholded Ordered Sparse Canonical Correlation Analysis (TOSCCA), descibed in [(Senar N. et al, nd)](https://arxiv.org/abs/2310.02169) for the analysis and integration of two datasets, at least one of which is high-dimensional. TOSCCA is an extension of the sparse CCA method based on soft-thresholding that produces near-orthogonal
...
```{r}
cpev_pma = sapply(1:K, function(k) cpev.fun(X, cca_pma$u[,1:k]))
