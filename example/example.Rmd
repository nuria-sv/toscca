...
for (i in 1:length(nonz_x)) {
  cca_res =  toscca::MSCCA(X, Y, K = 2, nonzero_a = rep(nonz_x[i],2), nonzero_b = c(50,nonz_y), combination = FALSE, toPlot = FALSE, alpha_init = "uniform")
...
kable(
  rbind(adj_cpev_pma, adj_cpev_toscca),
